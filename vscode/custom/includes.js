...
fs.writeFileSync(`${basePath}/build/json/_silver.json`, JSON.stringify(silver, null, 2));
fs.writeFileSync(`${basePath}/build/json/_gold.json`, JSON.stringify(gold, null, 2));
